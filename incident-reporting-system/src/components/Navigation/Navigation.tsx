      ...
      <nav className="sidebar-nav">
        <button className="sidebar-item" onClick={() => handleNavigation('/')} title="Dashboard">
          <svg className="sidebar-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
            <path d="M3 11.5L12 4l9 7.5" stroke="#BA0C2F" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M5 21V12h14v9" stroke="#333" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        ...
        <button className="sidebar-item" onClick={() => handleNavigation('/upload')} title="Upload">
          <svg className="sidebar-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
            <path d="M12 3v12" stroke="#BA0C2F" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M7 8l5-5 5 5" stroke="#BA0C2F" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M21 21H3" stroke="#333" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
